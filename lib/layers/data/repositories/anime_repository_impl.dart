...
@override
Future<Either<String, List<AnimeEntity>>> getUpcoming({int page = 1, int limit = 20}) async {
  final result = await _service.getUpcomingAnime(page: page, limit: limit);
  return result.fold((l) => Left(l), (r) => Right(r));
}

@override
Future<Either<String, List<AnimeEntity>>> getCurrentYearAnime({int page = 1, int limit = 20}) async {
